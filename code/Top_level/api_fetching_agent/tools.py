...
#     print("=" * 60)
#     print("Testing fetch_weather on 3 cities")
#     print("=" * 60)
...
#     print("\n" + "=" * 60)
#     print("Testing fetch_exchange_rate tool")
#     print("=" * 60)
...
#         try:
#             print(f"\n💱 Fetching exchange rate from {base} to {target}...")
#             result = fetch_exchange_rate(base, target)
#             rate = result["exchange_rate"]
#             print(f"✅ 1 {rate['base']} = {rate['rate']} {rate['target']}")
#             print(f"   Date: {result['api_metadata']['date']}")
#         except Exception as e:
